...
def get_signals(db):
    ...
    query1 = 'SELECT signal_elec1_subelec1, signal_elec1_subelec2, \
             ...
             signal_elec2_subelec3 from data_set WHERE EEG_data_section=1 LIMIT 0,2200'
    query2 = 'SELECT signal_elec3_subelec1, signal_elec3_subelec2, \
             ...
             signal_elec4_subelec3 FROM data_set WHERE EEG_data_section=2 LIMIT 0,2200'
...
def get_results(db):
    ...
    query = 'SELECT stm, stm_confidence_level, stm_remember_know, ltm, \
             ltm_confidence_level, ltm_remember_know FROM data_set WHERE EEG_data_section=1 LIMIT 0,2200'
